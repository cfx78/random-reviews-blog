					...
					<div className="grid grid-cols-1 h-fit gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
						<div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
							...
							<p className="mt-4 flex flex-col text-center justify-center items-center text-gray-200 md:pb-9">
								...
								This along with other relative information will
								be displayed on the cards located on the
								category page. The reviews will contain a brief
								summary, a list of pros, a list of cons, and my
								opinion on who will enjoy the material. I will
								also try to keep the reviews spoiler free when
								it comes to games, movies, and shows. If you
								want to know more about a review, click the link
